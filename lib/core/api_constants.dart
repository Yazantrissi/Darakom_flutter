...
/// Local API base URL resolved per platform to avoid Connection Refused.
class ApiConstants {
  /// Set true + [lanHost] when testing on a physical device on the same Wi‑Fi.
  static const bool useLanHost = false;
  static const String lanHost = '192.168.1.10';
  static const int apiPort = 8000;

  static String get origin {
    if (useLanHost) return 'http://$lanHost:$apiPort';
